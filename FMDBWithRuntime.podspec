...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A short description of FMDBWithRuntime."
  ...
  # Or just: s.author    = "sfwan2014"
  # s.authors            = { "sfwan2014" => "sfwan2014@github.com" }
  # s.social_media_url   = "http://twitter.com/sfwan2014"
  ...
  s.source       = { :git => "https://github.com/sfwan2014/FMDBWithRuntime.git”, :tag => s.version.to_s }
